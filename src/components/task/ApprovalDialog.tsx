  ...
  return (
    <div class="mx-2 my-1.5 p-2 border border-accent-warning/40 bg-accent-warning/5">
      ...
      <div class="flex gap-1.5">
        <button
          type="button"
          class="flex-1 px-2 py-1 text-xs font-medium text-green-400 border border-green-400/40 hover:bg-green-400/10 cursor-pointer"
        ...
        <button
          type="button"
          class="flex-1 px-2 py-1 text-xs font-medium text-red-400 border border-red-400/40 hover:bg-red-400/10 cursor-pointer"
