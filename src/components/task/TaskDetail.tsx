          ...
          fallback={
            <div class="px-3 py-4 text-center">
              ...
              <Show when={worktree()}>
                <button
                  type="button"
                  class="text-xs text-accent-primary hover:text-accent-primary/80 cursor-pointer"
        ...
        >
          {(t) => (
            <>
              {/* 1. Task Header */}
              <div class="px-3 py-2 border-b border-border-subtle">
                <div class="text-xs text-text-main font-medium truncate">
                ...
                {/* Metadata */}
                <div class="flex items-center gap-2 mt-1 text-xs text-text-dim">
                ...
                <div class="flex items-center gap-1.5 mt-2">
                  <Show when={canLaunch() && t().frontmatter.status === 'created'}>
                    <button
                      type="button"
                      class="px-2 py-1 text-xs text-text-dim hover:text-text-main border border-border-subtle hover:border-accent-primary cursor-pointer"
                  ...
                  <Show when={taskStore.state.activeRun && t().frontmatter.status === 'running'}>
                    <button
                      type="button"
                      class="px-2 py-1 text-xs text-red-400 hover:text-red-300 border border-border-subtle hover:border-red-400 cursor-pointer"
                  ...
                  >
                    ...
                    <button
                      type="button"
                      class="px-2 py-1 text-xs text-text-dim hover:text-text-main border border-border-subtle hover:border-accent-info cursor-pointer"
                ...
                <Show when={launchError()}>
                  <p class="mt-1 text-xs text-accent-error truncate">{launchError()}</p>
                </Show>
              </div>
              ...
              <Show when={knowledgeItems().length > 0}>
                <div class="border-b border-border-subtle">
                  ...
                  <Show when={knowledgeExpanded()}>
                    <div class="px-3 pb-2">
                      <div class="text-xs text-text-dim space-y-0.5 bg-bg-main/30 px-2 py-1.5 border border-border-subtle/30 max-h-32 overflow-y-auto">
