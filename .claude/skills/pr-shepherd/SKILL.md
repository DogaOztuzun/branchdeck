...
name: pr-shepherd
description: >
  Analyze and fix failing GitHub PRs. Check .branchdeck/analysis.json
  to determine current state. If no analysis exists, analyze the PR.
  If analysis is approved, execute the fix plan.
---
